...
<body style="min-height:100vh; background: linear-gradient(to bottom, #33ccff 0%, #ff99cc 100%);">
    <div class="header">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <img src="images/QR.jpg" style="width: 250px; height: 250px; position: absolute; top: 120px; left: 220px;" alt="qr">
