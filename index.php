...
<body>
            ...
            <div class="row">
                ...
                <div class="col-md-6">                                 
                    <?php 
                     ...
                     echo $num;
                    ?>
                    <div id="car" style="background: linear-gradient(to bottom, black 0%, red 100%);">
    ...
    <section style="height:100vh; background: linear-gradient(to bottom, #33ccff 0%, #ff99cc 100%);">
        <div class="container">
            <div class="row">
